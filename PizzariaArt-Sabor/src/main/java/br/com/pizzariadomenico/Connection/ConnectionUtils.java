...
public class ConnectionUtils {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            String serveName = "artesabor01.mysql.uhserver.com"; // Caminho do servidor do BD
            String mydatabase = "artesabor01"; // Nome do banco de dados
            String url = "jdbc:mysql://" + serveName + "/" + mydatabase;
            String username = "artesabor01"; // Nome de usuario
